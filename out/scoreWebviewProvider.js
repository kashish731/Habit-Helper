...
exports.ScoreWebviewProvider = void 0;
const scoreCalculator_1 = require("./scoreCalculator");
class ScoreWebviewProvider {
    _extensionUri;
    static viewType = "habitHelper.scoreView";
    _view;
    habits = [];
    ...
    updateContent() {
        ...
        const color = (0, scoreCalculator_1.getScoreColor)(score.totalScore);
...
exports.ScoreWebviewProvider = ScoreWebviewProvider;
//# sourceMappingURL=scoreWebviewProvider.js.map